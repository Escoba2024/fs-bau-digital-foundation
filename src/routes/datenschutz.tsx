...
export const Route = createFileRoute("/datenschutz")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://fs-bau-digital-foundation.vercel.app/datenschutz" },
    ...
    links: [{ rel: "canonical", href: "https://fs-bau-digital-foundation.vercel.app/datenschutz" }],
  }),
